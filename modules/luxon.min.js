/*eslint-disable */
class e extends Error {} class z extends e {constructor(e) { super(`Invalid DateTime: ${e.toMessage()}`); }} class A extends e {constructor(e) { super(`Invalid Interval: ${e.toMessage()}`); }} class q extends e {constructor(e) { super(`Invalid Duration: ${e.toMessage()}`); }} class j extends e {} class U extends e {constructor(e) { super(`Invalid unit ${e}`); }} class o extends e {} class r extends e {constructor() { super('Zone is an abstract class'); }} var t = 'numeric'; var n = 'short'; var s = 'long'; const _ = { year: t, month: t, day: t }; const $ = { year: t, month: n, day: t }; const H = {
  ...
  months(r, n = !1) { return Ie(this, r, mt, () => { const t = n ? { month: r, day: 'numeric' } : { month: r }; const e = n ? 'format' : 'standalone'; return this.monthsCache[e][r] || (this.monthsCache[e][r] = Ve((e) => this.extract(e, t, 'month'))), this.monthsCache[e][r]; }); }
  ...
  meridiems() { return Ie(this, void 0, () => wt, () => { if (!this.meridiemCache) { const t = { hour: 'numeric', hourCycle: 'h12' }; this.meridiemCache = [L.utc(2016, 11, 13, 9), L.utc(2016, 11, 13, 19)].map((e) => this.extract(e, t, 'dayperiod')); } return this.meridiemCache; }); }

  eras(e) { return Ie(this, e, Ot, () => { const t = { era: e }; return this.eraCache[e] || (this.eraCache[e] = [L.utc(-40, 1, 1), L.utc(2017, 1, 1)].map((e) => this.extract(e, t, 'era'))), this.eraCache[e]; }); }
  ...
  static get defaultLocale() { return Ue; }

  static set defaultLocale(e) { Ue = e; }

  static get defaultNumberingSystem() { return _e; }

  static set defaultNumberingSystem(e) { _e = e; }
  ...
  D: _, DD: $, DDD: W, DDDD: R, t: J, tt: Y, ttt: P, tttt: G, T: B, TT: Q, TTT: K, TTTT: X, f: ee, ff: re, fff: ie, ffff: oe, F: te, FF: ne, FFF: ae, FFFF: ue,
}; class T {
  ...
  dtFormatter(e, t = {}) { return this.loc.dtFormatter(e, { ...this.opts, ...t }); }

  formatDateTime(e, t) { return this.dtFormatter(e, t).format(); }

  formatDateTimeParts(e, t) { return this.dtFormatter(e, t).formatToParts(); }

  formatInterval(e, t) { return this.dtFormatter(e.start, t).dtf.formatRange(e.start.toJSDate(), e.end.toJSDate()); }

  resolvedOptions(e, t) { return this.dtFormatter(e, t).resolvedOptions(); }
  ...
  ...mr,
}; const yr = 365.2425; const gr = 30.436875; const vr = {
  years: {
    quarters: 4, months: 12, weeks: yr / 7, days: yr, hours: 24 * yr, minutes: 525949.2, seconds: 525949.2 * 60, milliseconds: 525949.2 * 60 * 1e3,
  },
  quarters: {
    months: 3, weeks: yr / 28, days: yr / 4, hours: 24 * yr / 4, minutes: 131487.3, seconds: 525949.2 * 60 / 4, milliseconds: 7889237999.999999,
  },
  months: {
    weeks: gr / 7, days: gr, hours: 24 * gr, minutes: 43829.1, seconds: 2629746, milliseconds: 2629746e3,
  },
  ...mr,
}; const M = ['years', 'quarters', 'months', 'weeks', 'days', 'hours', 'minutes', 'seconds', 'milliseconds']; const wr = M.slice(0).reverse(); function D(e, t, r = !1) {
  r = {
...
} function pr(e) { return Math.trunc(1e3 * e) / 1e3; } function Tr(e, t, r, n, s) { var e = e[s][r]; var i = t[r] / e; var i = Math.floor(i); n[s] = pr(n[s] + i), t[r] = pr(t[r] - i * e); } function Sr(r, n) { wr.reduce((e, t) => (w(n[t]) ? e : (e && Tr(r, n, e, n, t), t)), null); } function Or(e) { let t; let r; const n = {}; for ([t, r] of Object.entries(e))r !== 0 && (n[t] = r); return n; } class E {
  constructor(e) { const t = e.conversionAccuracy === 'longterm' || !1; let r = t ? vr : fr; e.matrix && (r = e.matrix), this.values = e.values, this.loc = e.loc || y.create(), this.conversionAccuracy = t ? 'longterm' : 'casual', this.invalid = e.invalid || null, this.matrix = r, this.isLuxonDuration = !0; }

  static fromMillis(e, t) { return E.fromObject({ milliseconds: e }, t); }

  static fromObject(e, t = {}) {
    if (e == null || typeof e !== 'object') throw new o(`Duration.fromObject: argument expected to be an object, got ${e === null ? 'null' : typeof e}`); return new E({
      values: ot(e, E.normalizeUnit), loc: y.fromObject(t), conversionAccuracy: t.conversionAccuracy, matrix: t.matrix,
    });
  }

  static fromDurationLike(e) { if (c(e)) return E.fromMillis(e); if (E.isDuration(e)) return e; if (typeof e === 'object') return E.fromObject(e); throw new o(`Unknown duration argument ${e} of type ${typeof e}`); }

  static fromISO(e, t) { const [r] = ar(e); return r ? E.fromObject(r, t) : E.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }

  static fromISOTime(e, t) { const [r] = ur(e); return r ? E.fromObject(r, t) : E.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }

  static invalid(e, t = null) { if (!e) throw new o('need to specify a reason the Duration is invalid'); e = e instanceof S ? e : new S(e, t); if (v.throwOnInvalid) throw new q(e); return new E({ invalid: e }); }
  ...
  static normalizeUnit(e) {
    ...
    }[e && e.toLowerCase()]; if (t) return t; throw new U(e);
  }
  ...
  toISOTime(e = {}) {
    let t; return !this.isValid || (t = this.toMillis()) < 0 || t >= 864e5 ? null : (e = {
      suppressMilliseconds: !1, suppressSeconds: !1, includePrefix: !1, format: 'extended', ...e, includeOffset: !1,
  ...
  toMillis() { let e = this.values.milliseconds ?? 0; for (const t of wr.slice(1)) this.values?.[t] && (e += this.values[t] * this.matrix[t].milliseconds); return e; }

  valueOf() { return this.toMillis(); }

  plus(e) { if (!this.isValid) return this; const t = E.fromDurationLike(e); const r = {}; for (const n of M)(l(t.values, n) || l(this.values, n)) && (r[n] = t.get(n) + this.get(n)); return D(this, { values: r }, !0); }

  minus(e) { return this.isValid ? (e = E.fromDurationLike(e), this.plus(e.negate())) : this; }

  mapUnits(e) { if (!this.isValid) return this; const t = {}; for (const r of Object.keys(this.values))t[r] = at(e(this.values[r], r)); return D(this, { values: t }, !0); }

  get(e) { return this[E.normalizeUnit(e)]; }

  set(e) { return this.isValid ? D(this, { values: { ...this.values, ...ot(e, E.normalizeUnit) } }) : this; }

  reconfigure({
    locale: e, numberingSystem: t, conversionAccuracy: r, matrix: n,
  } = {}) { e = this.loc.clone({ locale: e, numberingSystem: t }); return D(this, { loc: e, matrix: n, conversionAccuracy: r }); }

  as(e) { return this.isValid ? this.shiftTo(e).get(e) : NaN; }

  normalize() { let e; return this.isValid ? (e = this.toObject(), this.valueOf() >= 0 ? (Sr(this.matrix, e), D(this, { values: e }, !0)) : this.negate().normalize().negate()) : this; }

  rescale() { let e; return this.isValid ? (e = Or(this.normalize().shiftToAll().toObject()), D(this, { values: e }, !0)) : this; }

  shiftTo(...e) { if (!this.isValid) return this; if (e.length === 0) return this; e = e.map((e) => E.normalizeUnit(e)); const t = {}; const r = {}; const n = this.toObject(); let s; for (const a of M) if (e.indexOf(a) >= 0) { s = a; let e = 0; for (const o in r)e += this.matrix[o][a] * r[o], r[o] = 0; c(n[a]) && (e += n[a]); const i = Math.trunc(e); t[a] = i, r[a] = (1e3 * e - 1e3 * i) / 1e3; for (const u in n)M.indexOf(u) > M.indexOf(a) && Tr(this.matrix, n, u, t, a); } else c(n[a]) && (r[a] = n[a]); for (const l in r)r[l] !== 0 && (t[s] += l === s ? r[l] : r[l] / this.matrix[s][l]); return D(this, { values: t }, !0).normalize(); }

  shiftToAll() { return this.isValid ? this.shiftTo('years', 'months', 'weeks', 'days', 'hours', 'minutes', 'seconds', 'milliseconds') : this; }

  negate() { if (!this.isValid) return this; const e = {}; for (const t of Object.keys(this.values))e[t] = this.values[t] === 0 ? 0 : -this.values[t]; return D(this, { values: e }, !0); }
  ...
  equals(e) { if (!this.isValid || !e.isValid) return !1; if (!this.loc.equals(e.loc)) return !1; for (const n of M) if (t = this.values[n], r = e.values[n], !(void 0 === t || t === 0 ? void 0 === r || r === 0 : t === r)) return !1; let t; let r; return !0; }
} const br = 'Invalid Interval'; function kr(e, t) { return e && e.isValid ? t && t.isValid ? t < e ? V.invalid('end before start', `The end of an interval must be after its start, but you had start=${e.toISO()} and end=${t.toISO()}`) : null : V.invalid('missing or invalid end') : V.invalid('missing or invalid start'); } class V {
  constructor(e) { this.s = e.start, this.e = e.end, this.invalid = e.invalid || null, this.isLuxonInterval = !0; }

  static invalid(e, t = null) { if (!e) throw new o('need to specify a reason the Interval is invalid'); e = e instanceof S ? e : new S(e, t); if (v.throwOnInvalid) throw new A(e); return new V({ invalid: e }); }

  static fromDateTimes(e, t) { var e = Nn(e); var t = Nn(t); const r = kr(e, t); return r == null ? new V({ start: e, end: t }) : r; }

  static after(e, t) { t = E.fromDurationLike(t), e = Nn(e); return V.fromDateTimes(e, e.plus(t)); }

  static before(e, t) { t = E.fromDurationLike(t), e = Nn(e); return V.fromDateTimes(e.minus(t), e); }

  static fromISO(e, s) { const [i, a] = (e || '').split('/', 2); if (i && a) { let e; let t; try { e = L.fromISO(i, s), t = e.isValid; } catch (a) { t = !1; }let r; let n; try { r = L.fromISO(a, s), n = r.isValid; } catch (a) { n = !1; } if (t && n) return V.fromDateTimes(e, r); if (t) { var o = E.fromISO(a, s); if (o.isValid) return V.after(e, o); } else if (n) { o = E.fromISO(i, s); if (o.isValid) return V.before(r, o); } } return V.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }
  ...
  set({ start: e, end: t } = {}) { return this.isValid ? V.fromDateTimes(e || this.s, t || this.e) : this; }

  splitAt(...e) {
    if (!this.isValid) return []; const t = e.map(Nn).filter((e) => this.contains(e)).sort(); const r = []; let n = this.s; let
      s = 0; for (;n < this.e;) { var i = t[s] || this.e; var i = +i > +this.e ? this.e : i; r.push(V.fromDateTimes(n, i)), n = i, s += 1; } return r;
  }

  splitBy(e) {
    const t = E.fromDurationLike(e); if (!this.isValid || !t.isValid || t.as('milliseconds') === 0) return []; let r = this.s; let n = 1; let
      s; for (var i = []; r < this.e;) { const a = this.start.plus(t.mapUnits((e) => e * n)); s = +a > +this.e ? this.e : a, i.push(V.fromDateTimes(r, s)), r = s, n += 1; } return i;
  }
  ...
  intersection(e) { let t; return this.isValid ? (t = (this.s > e.s ? this : e).s, (e = (this.e < e.e ? this : e).e) <= t ? null : V.fromDateTimes(t, e)) : this; }

  union(e) { let t; return this.isValid ? (t = (this.s < e.s ? this : e).s, e = (this.e > e.e ? this : e).e, V.fromDateTimes(t, e)) : this; }
  ...
  static xor(e) { let t = null; let r = 0; const n = []; var e = e.map((e) => [{ time: e.s, type: 's' }, { time: e.e, type: 'e' }]); for (const s of Array.prototype.concat(...e).sort((e, t) => e.time - t.time))r += s.type === 's' ? 1 : -1, t = r === 1 ? s.time : (t && +t != +s.time && n.push(V.fromDateTimes(t, s.time)), null); return V.merge(n); }

  difference(...e) { return V.xor([this].concat(e)).map((e) => this.intersection(e)).filter((e) => e && !e.isEmpty()); }

  toString() { return this.isValid ? `[${this.s.toISO()} – ${this.e.toISO()})` : br; }

  toLocaleString(e = _, t = {}) { return this.isValid ? T.create(this.s.loc.clone(t), e).formatInterval(this) : br; }

  toISO(e) { return this.isValid ? `${this.s.toISO(e)}/${this.e.toISO(e)}` : br; }

  toISODate() { return this.isValid ? `${this.s.toISODate()}/${this.e.toISODate()}` : br; }

  toISOTime(e) { return this.isValid ? `${this.s.toISOTime(e)}/${this.e.toISOTime(e)}` : br; }

  toFormat(e, { separator: t = ' – ' } = {}) { return this.isValid ? `${this.s.toFormat(e)}${t}${this.e.toFormat(e)}` : br; }

  toDuration(e, t) { return this.isValid ? this.e.diff(this.s, e, t) : E.invalid(this.invalidReason); }

  mapEndpoints(e) { return V.fromDateTimes(e(this.s), e(this.e)); }
} class Nr {
...
} function Mr(e, t) { const r = (e) => e.toUTC(0, { keepLocalTime: !0 }).startOf('day').valueOf(); var t = r(t) - r(e); return Math.floor(E.fromMillis(t).as('days')); } function Dr(e, t, r, n) { let[s, i, a, o] = (function (e, t, r) { let n; let s; const i = {}; const a = e; let o; let u; for ([n, s] of [['years', (e, t) => t.year - e.year], ['quarters', (e, t) => t.quarter - e.quarter + 4 * (t.year - e.year)], ['months', (e, t) => t.month - e.month + 12 * (t.year - e.year)], ['weeks', (e, t) => { e = Mr(e, t); return (e - e % 7) / 7; }], ['days', Mr]])r.indexOf(n) >= 0 && (i[o = n] = s(e, t), (u = a.plus(i)) > t ? (i[n]--, t < (e = a.plus(i)) && (u = e, i[n]--, e = a.plus(i))) : e = u); return [e, i, u, o]; }(e, t, r)); e = t - s, r = r.filter((e) => ['hours', 'minutes', 'seconds', 'milliseconds'].indexOf(e) >= 0), r.length === 0 && (a = a < t ? s.plus({ [o]: 1 }) : a) !== s && (i[o] = (i[o] || 0) + e / (a - s)), t = E.fromObject(i, n); return r.length > 0 ? E.fromMillis(e, n).shiftTo(...r).plus(t) : t; } const Er = {
...
}; const xr = Er.hanidec.replace(/[\[|\]]/g, '').split(''); function x({ numberingSystem: e }, t = '') { return new RegExp(`${Er[e || 'latn']}${t}`); } const Ir = 'missing Intl.DateTimeFormat.formatToParts support'; function I(e, t = (e) => e) { return { regex: e, deser: ([e]) => t(function (t) { let r = parseInt(t, 10); if (isNaN(r)) { r = ''; for (let e = 0; e < t.length; e++) { const n = t.charCodeAt(e); if (t[e].search(Er.hanidec) !== -1)r += xr.indexOf(t[e]); else for (const a in Vr) { const [s, i] = Vr[a]; s <= n && n <= i && (r += n - s); } } return parseInt(r, 10); } return r; }(e)) }; } const Cr = `[ ${String.fromCharCode(160)}]`; const Zr = new RegExp(Cr, 'g'); function Fr(e) { return e.replace(/\./g, '\\.?').replace(Zr, Cr); } function Lr(e) { return e.replace(/\./g, '').replace(Zr, ' ').toLowerCase(); } function C(e, r) { return e === null ? null : { regex: RegExp(e.map(Fr).join('|')), deser: ([t]) => e.findIndex((e) => Lr(t) === Lr(e)) + r }; } function zr(e, t) { return { regex: e, deser: ([, e, t]) => it(e, t), groups: t }; } function Ar(e) { return { regex: e, deser: ([e]) => e }; } const qr = {
  ...
  } = _r(e, t, r); return [e, t, r, n];
} function Hr(o, e) { if (!o) return null; var e = T.create(e, o).dtFormatter(jr = jr || L.fromMillis(1555555555555)); const t = e.formatToParts(); const u = e.resolvedOptions(); return t.map((r) => { { const n = o; const s = u; var { type: r, value: i } = r; if (r === 'literal') return { literal: !(a = /^\s+$/.test(i)), val: a ? ' ' : i }; var a = n[r]; let e = r; let t = (r === 'hour' && (e = n.hour12 != null ? n.hour12 ? 'hour12' : 'hour24' : n.hourCycle != null ? n.hourCycle === 'h11' || n.hourCycle === 'h12' ? 'hour12' : 'hour24' : s.hour12 ? 'hour12' : 'hour24'), qr[e]); return (t = typeof t === 'object' ? t[a] : t) ? { literal: !1, val: t } : void 0; } }); } const Wr = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]; const Rr = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335]; function Z(e, t) { return new S('unit out of range', `you specified ${t} (of type ${typeof t}) as a ${e}, which is invalid`); } function Jr(e, t, r) { t = new Date(Date.UTC(e, t - 1, r)), e < 100 && e >= 0 && t.setUTCFullYear(t.getUTCFullYear() - 1900), r = t.getUTCDay(); return r === 0 ? 7 : r; } function Yr(e, t, r) { return r + (Ke(e) ? Rr : Wr)[t - 1]; } function Pr(e, t) { var e = Ke(e) ? Rr : Wr; const r = e.findIndex((e) => e < t); return { month: r + 1, day: t - e[r] }; } function Gr(e) {
  var { year: t, month: r, day: n } = e; const s = Yr(t, r, n); var r = Jr(t, r, n); let i = Math.floor((s - r + 10) / 7); let a; return i < 1 ? (a = t - 1, i = rt(a)) : i > rt(t) ? (a = t + 1, i = 1) : a = t, {
    weekYear: a, weekNumber: i, weekday: r, ...lt(e),
  };
} function Br(e) {
  var { weekYear: t, weekNumber: r, weekday: n } = e; const s = Jr(t, 1, 4); const i = Xe(t); let a = 7 * r + n - s - 3; let o; a < 1 ? (o = t - 1, a += Xe(o)) : a > i ? (o = t + 1, a -= Xe(t)) : o = t; var { month: r, day: n } = Pr(o, a); return {
    year: o, month: r, day: n, ...lt(e),
  };
} function Qr(e) { const { year: t, month: r, day: n } = e; return { year: t, ordinal: Yr(t, r, n), ...lt(e) }; } function Kr(e) {
  var { year: t, ordinal: r } = e; var { month: r, day: n } = Pr(t, r); return {
    year: t, month: r, day: n, ...lt(e),
  };
} function Xr(e) { const t = Re(e.weekYear); const r = h(e.weekNumber, 1, rt(e.weekYear)); const n = h(e.weekday, 1, 7); return t ? r ? !n && Z('weekday', e.weekday) : Z('week', e.week) : Z('weekYear', e.weekYear); } function en(e) { const t = Re(e.year); const r = h(e.ordinal, 1, Xe(e.year)); return t ? !r && Z('ordinal', e.ordinal) : Z('year', e.year); } function tn(e) { const t = Re(e.year); const r = h(e.month, 1, 12); const n = h(e.day, 1, et(e.year, e.month)); return t ? r ? !n && Z('day', e.day) : Z('month', e.month) : Z('year', e.year); } function rn(e) {
  var {
    hour: e, minute: t, second: r, millisecond: n,
  } = e; const s = h(e, 0, 23) || e === 24 && t === 0 && r === 0 && n === 0; const i = h(t, 0, 59); const a = h(r, 0, 59); const o = h(n, 0, 999); return s ? i ? a ? !o && Z('millisecond', n) : Z('second', r) : Z('minute', t) : Z('hour', e);
} const nn = 'Invalid DateTime'; function sn(e) { return new S('unsupported zone', `the zone "${e.name}" is not supported`); } function an(e) { return e.weekData === null && (e.weekData = Gr(e.c)), e.weekData; } function F(e, t) {
  e = {
    ts: e.ts, zone: e.zone, c: e.c, o: e.o, loc: e.loc, invalid: e.invalid,
  }; return new L({ ...e, ...t, old: e });
} function on(e, t, r) { let n = e - 60 * t * 1e3; const s = r.offset(n); return t === s ? [n, t] : s === (r = r.offset(n -= 60 * (s - t) * 1e3)) ? [n, s] : [e - 60 * Math.min(s, r) * 1e3, Math.max(s, r)]; } function un(e, t) {
...
} function ln(e, t, r) { return on(tt(e), t, r); } function cn(e, t) {
  ...
  }).as('milliseconds'); let[i, a] = on(tt(n), r, e.zone); return s !== 0 && (i += s, a = e.zone.offset(i)), { ts: i, o: a };
} function hn(e, t, r, n, s, i) { const { setZone: a, zone: o } = r; return e && Object.keys(e).length !== 0 || t ? (t = t || o, e = L.fromObject(e, { ...r, zone: t, specificOffset: i }), a ? e : e.setZone(o)) : L.invalid(new S('unparsable', `the input "${s}" can't be parsed as ${n}`)); } function dn(e, t, r = !0) { return e.isValid ? T.create(y.create('en-US'), { allowZ: r, forceSimple: !0 }).formatDateTimeFromString(e, t) : null; } function mn(e, t) { const r = e.c.year > 9999 || e.c.year < 0; let n = ''; return r && e.c.year >= 0 && (n += '+'), n += m(e.c.year, r ? 6 : 4), n = t ? (n = `${(n += '-') + m(e.c.month)}-`) + m(e.c.day) : (n += m(e.c.month)) + m(e.c.day); } function fn(e, t, r, n, s, i) { let a = m(e.c.hour); return t ? (a = (a += ':') + m(e.c.minute), e.c.millisecond === 0 && e.c.second === 0 && r || (a += ':')) : a += m(e.c.minute), e.c.millisecond === 0 && e.c.second === 0 && r || (a += m(e.c.second), e.c.millisecond === 0 && n) || (a = (a += '.') + m(e.c.millisecond, 3)), s && (e.isOffsetFixed && e.offset === 0 && !i ? a += 'Z' : a = e.o < 0 ? (a = `${(a += '-') + m(Math.trunc(-e.o / 60))}:`) + m(Math.trunc(-e.o % 60)) : (a = `${(a += '+') + m(Math.trunc(e.o / 60))}:`) + m(Math.trunc(e.o % 60))), i && (a += `[${e.zone.ianaName}]`), a; } const yn = {
...
}; const wn = ['year', 'month', 'day', 'hour', 'minute', 'second', 'millisecond']; const pn = ['weekYear', 'weekNumber', 'weekday', 'hour', 'minute', 'second', 'millisecond']; const Tn = ['year', 'ordinal', 'hour', 'minute', 'second', 'millisecond']; function Sn(e) {
  const t = {
  ...
  }[e.toLowerCase()]; if (t) return t; throw new U(e);
} function On(e, t) {
  const r = g(t.zone, v.defaultZone); var t = y.fromObject(t); const n = v.now(); let s; let i; if (w(e.year))s = n; else { for (const o of wn)w(e[o]) && (e[o] = yn[o]); let a = tn(e) || rn(e); if (a) return L.invalid(a); a = r.offset(n); [s, i] = ln(e, a, r); } return new L({
    ts: s, zone: r, loc: t, o: i,
  });
} function bn(t, r, n) { const s = !!w(n.round) || n.round; const e = (e, t) => (e = Qe(e, s || n.calendary ? 0 : 2, !0), r.loc.clone(n).relFormatter(n).format(e, t)); const i = (e) => (n.calendary ? r.hasSame(t, e) ? 0 : r.startOf(e).diff(t.startOf(e), e).get(e) : r.diff(t, e).get(e)); if (n.unit) return e(i(n.unit), n.unit); for (const o of n.units) { const a = i(o); if (Math.abs(a) >= 1) return e(a, o); } return e(r < t ? -0 : 0, n.units[n.units.length - 1]); } function kn(e) { let t = {}; let r; return r = e.length > 0 && typeof e[e.length - 1] === 'object' ? (t = e[e.length - 1], Array.from(e).slice(0, e.length - 1)) : Array.from(e), [t, r]; } class L {
  constructor(e) { let t; const r = e.zone || v.defaultZone; let n = e.invalid || (Number.isNaN(e.ts) ? new S('invalid input') : null) || (r.isValid ? null : sn(r)); let s = (this.ts = w(e.ts) ? v.now() : e.ts, null); let i = null; n || (e.old && e.old.ts === this.ts && e.old.zone.equals(r) ? [s, i] = [e.old.c, e.old.o] : (t = r.offset(this.ts), s = un(this.ts, t), n = Number.isNaN(s.year) ? new S('invalid input') : null, s = n ? null : s, i = n ? null : t)), this._zone = r, this.loc = e.loc || y.create(), this.invalid = n, this.weekData = null, this.c = s, this.o = i, this.isLuxonDateTime = !0; }

  static now() { return new L({}); }

  static local() {
    var [e, t] = kn(arguments); var [t, r, n, s, i, a, o] = t; return On({
      year: t, month: r, day: n, hour: s, minute: i, second: a, millisecond: o,
    }, e);
  }

  static utc() {
    var [e, t] = kn(arguments); var [t, r, n, s, i, a, o] = t; return e.zone = d.utcInstance, On({
      year: t, month: r, day: n, hour: s, minute: i, second: a, millisecond: o,
    }, e);
  }

  static fromJSDate(e, t = {}) { let r; var e = Je(e) ? e.valueOf() : NaN; return Number.isNaN(e) ? L.invalid('invalid input') : (r = g(t.zone, v.defaultZone)).isValid ? new L({ ts: e, zone: r, loc: y.fromObject(t) }) : L.invalid(sn(r)); }
  ...
  static fromObject(e, t = {}) {
    e = e || {}; const r = g(t.zone, v.defaultZone); if (!r.isValid) return L.invalid(sn(r)); let n = v.now(); const s = w(t.specificOffset) ? r.offset(n) : t.specificOffset; const i = ot(e, Sn); const a = !w(i.ordinal); var o = !w(i.year); let u = !w(i.month) || !w(i.day); var o = o || u; var l = i.weekYear || i.weekNumber; var t = y.fromObject(t); if ((o || a) && l) throw new j("Can't mix weekYear/weekNumber units with year/month/day or ordinals"); if (u && a) throw new j("Can't mix ordinal dates with month/day"); u = l || i.weekday && !o; let c; let h; let d = un(n, s); let m = (u ? (c = pn, h = gn, d = Gr(d)) : a ? (c = Tn, h = vn, d = Qr(d)) : (c = wn, h = yn), !1); for (const f of c)w(i[f]) ? m ? i[f] = h[f] : i[f] = d[f] : m = !0; var l = (u ? Xr : a ? en : tn)(i) || rn(i); return l ? L.invalid(l) : ([n, l] = ln(u ? Br(i) : a ? Kr(i) : i, s, r), u = new L({
  ...
  static fromISO(e, t = {}) { const [r, n] = nr(e); return hn(r, n, t, 'ISO 8601', e); }

  static fromRFC2822(e, t = {}) { const [r, n] = sr(e); return hn(r, n, t, 'RFC 2822', e); }

  static fromHTTP(e, t = {}) { var [e, r] = ir(e); return hn(e, r, t, 'HTTP', t); }

  static fromFormat(e, t, r = {}) { if (w(e) || w(t)) throw new o('fromFormat requires an input string and a format'); var { locale: n = null, numberingSystem: s = null } = r; var [n, s, i, a] = $r(y.fromOpts({ locale: n, numberingSystem: s, defaultToEN: !0 }), e, t); return a ? L.invalid(a) : hn(n, s, r, `format ${t}`, e, i); }

  static fromString(e, t, r = {}) { return L.fromFormat(e, t, r); }

  static fromSQL(e, t = {}) { const [r, n] = dr(e); return hn(r, n, t, 'SQL', e); }
  ...
  static parseFormatForOpts(e, t = {}) { e = Hr(e, y.fromObject(t)); return e ? e.map((e) => (e ? e.val : null)).join('') : null; }

  static expandFormat(e, t = {}) { return Ur(T.parseFormat(e), y.fromObject(t)).map((e) => e.val).join(''); }
  ...
  get weekYear() { return this.isValid ? an(this).weekYear : NaN; }

  get weekNumber() { return this.isValid ? an(this).weekNumber : NaN; }

  get weekday() { return this.isValid ? an(this).weekday : NaN; }

  get ordinal() { return this.isValid ? Qr(this.c).ordinal : NaN; }

  get monthShort() { return this.isValid ? Nr.months('short', { locObj: this.loc })[this.month - 1] : null; }

  get monthLong() { return this.isValid ? Nr.months('long', { locObj: this.loc })[this.month - 1] : null; }

  get weekdayShort() { return this.isValid ? Nr.weekdays('short', { locObj: this.loc })[this.weekday - 1] : null; }

  get weekdayLong() { return this.isValid ? Nr.weekdays('long', { locObj: this.loc })[this.weekday - 1] : null; }
  ...
  getPossibleOffsets() { let e; let t; let r; let n; return this.isValid && !this.isOffsetFixed && (e = tt(this.c), r = this.zone.offset(e - 864e5), n = this.zone.offset(e + 864e5), (r = this.zone.offset(e - 6e4 * r)) !== (n = this.zone.offset(e - 6e4 * n))) && (t = e - 6e4 * n, r = un(e -= 6e4 * r, r), n = un(t, n), r.hour === n.hour) && r.minute === n.minute && r.second === n.second && r.millisecond === n.millisecond ? [F(this, { ts: e }), F(this, { ts: t })] : [this]; }
  ...
  setZone(t, { keepLocalTime: r = !1, keepCalendarTime: n = !1 } = {}) { if ((t = g(t, v.defaultZone)).equals(this.zone)) return this; if (t.isValid) { let e = this.ts; return (r || n) && (r = t.offset(this.ts), n = this.toObject(), [e] = ln(n, r, t)), F(this, { ts: e, zone: t }); } return L.invalid(sn(t)); }

  reconfigure({ locale: e, numberingSystem: t, outputCalendar: r } = {}) { e = this.loc.clone({ locale: e, numberingSystem: t, outputCalendar: r }); return F(this, { loc: e }); }

  setLocale(e) { return this.reconfigure({ locale: e }); }

  set(e) { if (!this.isValid) return this; var e = ot(e, Sn); const t = !w(e.weekYear) || !w(e.weekNumber) || !w(e.weekday); const r = !w(e.ordinal); var n = !w(e.year); const s = !w(e.month) || !w(e.day); var i = e.weekYear || e.weekNumber; if ((n || s || r) && i) throw new j("Can't mix weekYear/weekNumber units with year/month/day or ordinals"); if (s && r) throw new j("Can't mix ordinal dates with month/day"); let a; t ? a = Br({ ...Gr(this.c), ...e }) : w(e.ordinal) ? (a = { ...this.toObject(), ...e }, w(e.day) && (a.day = Math.min(et(a.year, a.month), a.day))) : a = Kr({ ...Qr(this.c), ...e }); var [n, i] = ln(a, this.o, this.zone); return F(this, { ts: n, o: i }); }

  plus(e) { return this.isValid ? F(this, cn(this, E.fromDurationLike(e))) : this; }

  minus(e) { return this.isValid ? F(this, cn(this, E.fromDurationLike(e).negate())) : this; }

  startOf(e) { if (!this.isValid) return this; const t = {}; var e = E.normalizeUnit(e); switch (e) { case 'years': t.month = 1; case 'quarters': case 'months': t.day = 1; case 'weeks': case 'days': t.hour = 0; case 'hours': t.minute = 0; case 'minutes': t.second = 0; case 'seconds': t.millisecond = 0; } return e === 'weeks' && (t.weekday = 1), e === 'quarters' && (e = Math.ceil(this.month / 3), t.month = 3 * (e - 1) + 1), this.set(t); }

  endOf(e) { return this.isValid ? this.plus({ [e]: 1 }).startOf(e).minus(1) : this; }

  toFormat(e, t = {}) { return this.isValid ? T.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : nn; }

  toLocaleString(e = _, t = {}) { return this.isValid ? T.create(this.loc.clone(t), e).formatDateTime(this) : nn; }
  ...
  } = {}) { let i; return this.isValid ? (i = mn(this, e = e === 'extended'), (i += 'T') + fn(this, e, t, r, n, s)) : null; }

  toISODate({ format: e = 'extended' } = {}) { return this.isValid ? mn(this, e === 'extended') : null; }

  toISOWeekDate() { return dn(this, "kkkk-'W'WW-c"); }

  toISOTime({
    suppressMilliseconds: e = !1, suppressSeconds: t = !1, includeOffset: r = !0, includePrefix: n = !1, extendedZone: s = !1, format: i = 'extended',
  } = {}) { return this.isValid ? (n ? 'T' : '') + fn(this, i === 'extended', t, e, r, s) : null; }

  toRFC2822() { return dn(this, 'EEE, dd LLL yyyy HH:mm:ss ZZZ', !1); }

  toHTTP() { return dn(this.toUTC(), "EEE, dd LLL yyyy HH:mm:ss 'GMT'"); }

  toSQLDate() { return this.isValid ? mn(this, !0) : null; }

  toSQLTime({ includeOffset: e = !0, includeZone: t = !1, includeOffsetSpace: r = !0 } = {}) { let n = 'HH:mm:ss.SSS'; return (t || e) && (r && (n += ' '), t ? n += 'z' : e && (n += 'ZZ')), dn(this, n, !0); }

  toSQL(e = {}) { return this.isValid ? `${this.toSQLDate()} ${this.toSQLTime(e)}` : null; }

  toString() { return this.isValid ? this.toISO() : nn; }
  ...
  diff(e, t = 'milliseconds', r = {}) { let n; return this.isValid && e.isValid ? (r = { locale: this.locale, numberingSystem: this.numberingSystem, ...r }, t = Pe(t).map(E.normalizeUnit), e = Dr((n = e.valueOf() > this.valueOf()) ? this : e, n ? e : this, t, r), n ? e.negate() : e) : E.invalid('created by diffing an invalid DateTime'); }

  diffNow(e = 'milliseconds', t = {}) { return this.diff(L.now(), e, t); }

  until(e) { return this.isValid ? V.fromDateTimes(this, e) : this; }
  ...
  toRelative(e = {}) {
    if (!this.isValid) return null; const t = e.base || L.fromObject({}, { zone: this.zone }); const r = e.padding ? this < t ? -e.padding : e.padding : 0; let n = ['years', 'months', 'days', 'hours', 'minutes', 'seconds']; let s = e.unit; return Array.isArray(e.unit) && (n = e.unit, s = void 0), bn(t, this.plus(r), {
      ...e, numeric: 'always', units: n, unit: s,
    });
  }

  toRelativeCalendar(e = {}) {
    return this.isValid ? bn(e.base || L.fromObject({}, { zone: this.zone }), this, {
  ...
  static fromFormatExplain(e, t, r = {}) { var { locale: r = null, numberingSystem: n = null } = r; return _r(y.fromOpts({ locale: r, numberingSystem: n, defaultToEN: !0 }), e, t); }

  static fromStringExplain(e, t, r = {}) { return L.fromFormatExplain(e, t, r); }

  static get DATE_SHORT() { return _; }
...
} function Nn(e) { if (L.isDateTime(e)) return e; if (e && e.valueOf && c(e.valueOf())) return L.fromJSDate(e); if (e && typeof e === 'object') return L.fromObject(e); throw new o(`Unknown datetime argument: ${e}, of type ${typeof e}`); }s = '3.4.0'; export {
  L as DateTime, E as Duration, d as FixedOffsetZone, u as IANAZone, Nr as Info, V as Interval, Ae as InvalidZone, v as Settings, ce as SystemZone, s as VERSION, i as Zone,
};